...
namespace Modules\ApiGateway\Providers;
...
class ApiGatewayServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'ApiGateway';

    protected string $nameLower = 'apigateway';
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(GatewayService::class, function () {
